...
public class cadastroPrato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("Cadastro de Pratos");
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        ...
        pratos NovoPrato = new pratos(nome,descricao,valor);
        DatabasePratos criar = new DatabasePratos();
        criar.create(NovoPrato);
        JOptionPane.showMessageDialog(this, "O prato foi cadastrado com sucesso meu patrão!");
